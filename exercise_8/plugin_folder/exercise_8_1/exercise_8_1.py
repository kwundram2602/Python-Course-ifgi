...
/***************************************************************************
 MuensterCityDistrictTools.
                                 A QGIS plugin
 Gives information about selected district and can export features to csv file.
...
class MuensterCityDistrictTools:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'MuensterCityDistrictTools._{}.qm'.format(locale))
        ...
        self.toolbar = self.iface.addToolBar(u'MuensterCityDistrictTools.')
        self.toolbar.setObjectName(u'MuensterCityDistrictTools.')

        #print "** INITIALIZING MuensterCityDistrictTools."
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/exercise_8_1/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Muensterity District Tools'),
            callback=self.run,
    ...
    def onClosePlugin(self):
        ...
        #print "** CLOSING MuensterCityDistrictTools."
    ...
    def unload(self):
        ...
        #print "** UNLOAD MuensterCityDistrictTools."
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            #print "** STARTING MuensterCityDistrictTools."
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = MuensterCityDistrictTools.DockWidget()
